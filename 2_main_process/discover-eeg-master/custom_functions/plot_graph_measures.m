...
% Create colorbars in a way that avoids update conflicts
colorbar(ax_d(end),'eastoutside');
colorbar(ax_c(end),'eastoutside');

% Force a redraw of the figures to avoid ColorBar update issues
drawnow limitrate nocallbacks;
% Add a small pause to ensure all graphics operations complete
pause(0.1);
...
% Force a redraw of the figure to avoid ColorBar update issues
drawnow limitrate nocallbacks;
% Add a small pause to ensure all graphics operations complete
pause(0.1);
